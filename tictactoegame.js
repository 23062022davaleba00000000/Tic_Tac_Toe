...
flag = 1; // bool ტიპის ცვლადი.
function myfunc_3() {
	if (flag == 1) {
		document.getElementById("b1").value = "X"; // შესაბამის უჯრედში ისმება X.
		document.getElementById("b1").disabled = true; 
		flag = 0;
	}
	else { // წინააღმდეგ შემთხვევაში, შესაბამის უჯრედში ისმება 0.
...
function myfunc_4() {
	if (flag == 1) {
		document.getElementById("b2").value = "X"; // შესაბამის უჯრედში ისმება X.
		document.getElementById("b2").disabled = true;
		flag = 0;
	}
	else { // წინააღმდეგ შემთხვევაში, შესაბამის უჯრედში ისმება 0.
...
function myfunc_5() {
	if (flag == 1) {
		document.getElementById("b3").value = "X"; // შესაბამის უჯრედში ისმება X.
		document.getElementById("b3").disabled = true;
		flag = 0;
	}
	else { // წინააღმდეგ შემთხვევაში, შესაბამის უჯრედში ისმება 0.
...
function myfunc_6() {
	if (flag == 1) {
		document.getElementById("b4").value = "X"; // შესაბამის უჯრედში ისმება X.
		document.getElementById("b4").disabled = true;
		flag = 0;
	}
	else { // წინააღმდეგ შემთხვევაში, შესაბამის უჯრედში ისმება 0.
...
function myfunc_7() {
	if (flag == 1) {
		document.getElementById("b5").value = "X"; // შესაბამის უჯრედში ისმება X.
		document.getElementById("b5").disabled = true;
		flag = 0;
	}
	else { // წინააღმდეგ შემთხვევაში, შესაბამის უჯრედში ისმება 0.
...
function myfunc_8() {
	if (flag == 1) {
		document.getElementById("b6").value = "X"; // შესაბამის უჯრედში ისმება X.
		document.getElementById("b6").disabled = true;
		flag = 0;
	}
	else { // წინააღმდეგ შემთხვევაში, შესაბამის უჯრედში ისმება 0.
...
function myfunc_9() {
	if (flag == 1) {
		document.getElementById("b7").value = "X"; // შესაბამის უჯრედში ისმება X.
		document.getElementById("b7").disabled = true;
		flag = 0;
	}
	else { // წინააღმდეგ შემთხვევაში, შესაბამის უჯრედში ისმება 0.
...
function myfunc_10() {
	if (flag == 1) {
		document.getElementById("b8").value = "X"; // შესაბამის უჯრედში ისმება X.
		document.getElementById("b8").disabled = true;
		flag = 0;
	}
	else { // წინააღმდეგ შემთხვევაში, შესაბამის უჯრედში ისმება 0.
...
function myfunc_11() {
	if (flag == 1) {
		document.getElementById("b9").value = "X"; // შესაბამის უჯრედში ისმება X.
		document.getElementById("b9").disabled = true;
		flag = 0;
	}
	else { // წინააღმდეგ შემთხვევაში, შესაბამის უჯრედში ისმება 0.
